...
export declare function getOwnedLabel<V extends RuleConfigValue, O>(el: Element<V, O>, docuemnt: Document<V, O>): AbstractElement<V, O, MLASTElement | MLASTOmittedElement> | null;
